...
- [ ] Logging to file: add optional log file output (rotating or size-based), simplify console logs, and expose a `--log-file` flag with sensible defaults.
...
- [ ] Testing: introduce basic unit tests for token handling, listing, create/remove flows (mocking HTTP), and CLI entry points.
